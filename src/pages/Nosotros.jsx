...
const Nosotros = () => {
  return (
    <main>
      <section className="nosotros seccion-oscura d-flex flex-column justify-content-center align-items-center">
        <div className="contenedor text-center">
          <h2 className="seccion-titulo">CONOCÉ UN POCO MÁS SOBRE NOSOTROS</h2>
